...
const Spinner = class {
    ...
    getName() {
        const spinnerName = this.name || _config_6ccf652f_js__WEBPACK_IMPORTED_MODULE_1__["b"].get('spinner');
    ...
    render() {
        const self = this;
        const mode = Object(_core_5ba38749_js__WEBPACK_IMPORTED_MODULE_0__["d"])(self);
...
const buildLine = (spinner, duration, index, total) => {
    const data = spinner.fn(duration, index, total);
    data.style['animation-duration'] = duration + 'ms';
    return (Object(_core_5ba38749_js__WEBPACK_IMPORTED_MODULE_0__["h"])("svg", { viewBox: data.viewBox || '0 0 64 64', style: data.style }, Object(_core_5ba38749_js__WEBPACK_IMPORTED_MODULE_0__["h"])("line", { transform: "translate(32,32)", y1: data.y1, y2: data.y2 })));
};
